...
void CCS580ProjectApp::OnFileOpen()
{
	...
	CFileDialog fileDlg(TRUE, "obj", "*.obj", OFN_FILEMUSTEXIST, szFilters);
	...
	if( fileDlg.DoModal ()==IDOK )
	{
		...
		char filename[256];
		strcpy(filename, (LPCTSTR)m_strPathname);
		//ofstream fout("result.txt"); // open a file where the result of parsing will be written
